...
RSpec.describe "Carts", type: :request do
  ...
  context 'GET' do
    subject(:show_cart) { get api_v1_cart_path, headers: headers }
  ...
  context 'POST' do
    describe "/cart/add_item" do
      ...
      subject(:add_cart_item) { post add_item_api_v1_cart_path, params: { product_id: product_id }, headers: headers  }
      ...
      describe 'invalid when' do
        ...
        describe 'returns an error when there is insufficient stock' do
          ...
          subject(:add_cart_item) { post add_item_api_v1_cart_path, params: { product_id: product_id, quantity: 999 }, headers: headers  }
  ...
  context 'DELETE' do
    ...
    subject(:delete_cart_item) { delete remove_item_api_v1_cart_path, params: { product_id: product_id }, headers: headers  }
